...
//     }
    ...
    interestingUnits.sort((a,b) => (-1/Math.pow(1.4,a.action[0].rucho ? a.action[0].rucho.length : scian*scian)*(a.action[0].il) + 
                                     1/Math.pow(1.4,b.action[0].rucho ? b.action[0].rucho.length : scian*scian)*(b.action[0].il)))
